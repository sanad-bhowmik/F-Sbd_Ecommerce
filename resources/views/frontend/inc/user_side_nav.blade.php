            ...
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('profile') }}" class="aiz-side-nav-link {{ areActiveRoutes(['profile']) }}">
                        ...
                        <span class="aiz-side-nav-text ml-3"
                            style="color: black;">{{ translate('Manage Profile') }}</span>
                    </a>
                </li>
                @php
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('purchase_history.index') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3"
                            style="color: black;">{{ translate('Purchase History') }}</span>
                ...
                @if (addon_is_activated('refund_request'))
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('customer_refund_request') }}"
                            ...
                            <span class="aiz-side-nav-text ml-3"
                                style="color: black;">{{ translate('Refund Requests') }}</span>
                        </a>
                    </li>
                @endif
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('wishlists.index') }}"
                        ...
                        <svg id="Group_8116" data-name="Group 8116" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="14" viewBox="0 0 16 14">
                            <defs>
                ...
                <!-- Save For later -->
                <li class="aiz-side-nav-item">
                    <a href="{{ route('save_later') }}" class="aiz-side-nav-link {{ areActiveRoutes(['save_later']) }}">
                        <svg fill="#b5b5bf" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16"
                            viewBox="-15.44 -15.44 76.28 76.28" xml:space="preserve" stroke="#b5b5bf"
                        ...
                        <span class="aiz-side-nav-text ml-3"
                            style="color: black;">{{ translate('Save For later') }}</span>
                    </a>
                </li>
                <!-- Save For later -->
                <li class="aiz-side-nav-item">
                    <a href="{{ route('save_later') }}" class="aiz-side-nav-link {{ areActiveRoutes(['save_later']) }}">
                        <svg fill="#b5b5bf" height="16" width="16" version="1.1" id="Layer_1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            viewBox="0 0 512 512" xml:space="preserve" stroke="#b5b5bf">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <g>
                                ...
                                <g>
                                    <g>
                                        <path
                                            d="M350.457,115.925H161.543c-4.447,0-8.05,3.603-8.05,8.05v137.392c0,4.447,3.603,8.05,8.05,8.05h188.914 c4.447,0,8.05-3.603,8.05-8.05V123.975C358.507,119.528,354.904,115.925,350.457,115.925z M218.969,132.025h26.834v44.008h-26.834 V132.025z M299.472,253.317H169.593V132.025h33.275v52.059c0,4.447,3.603,8.05,8.05,8.05h42.935c4.447,0,8.05-3.603,8.05-8.05 v-52.059h37.568V253.317z M342.407,253.317h-26.834V132.025h26.834V253.317z">
                                        </path>
                                    </g>
                                </g>
                                <g>
                                    <g>
                                        <path
                                            d="M281.761,206.088h-92.31c-4.447,0-8.05,3.603-8.05,8.05s3.603,8.05,8.05,8.05h92.31c4.447,0,8.05-3.603,8.05-8.05 S286.208,206.088,281.761,206.088z">
                                        </path>
                                    </g>
                                </g>
                                <g>
                                    <g>
                                        <path
                                            d="M281.761,229.702h-92.31c-4.447,0-8.05,3.603-8.05,8.05s3.603,8.05,8.05,8.05h92.31c4.447,0,8.05-3.603,8.05-8.05 S286.208,229.702,281.761,229.702z">
                                        </path>
                                    </g>
                                </g>
                            </g>
                        </svg>
                        <span class="aiz-side-nav-text ml-3" style="color: black;">{{ translate('Track Order') }}</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item" style="display:none;">
                    <a href="{{ route('followed_seller') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3"
                            style="color: black;">{{ translate('Followed Sellers') }}</span>
                    </a>
                </li>
                ...
                @if (get_setting('classified_product') == 1)
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('customer_products.index') }}"
                            ...
                            <span class="aiz-side-nav-text ml-3"
                                style="color: black;">{{ translate('Classified Products') }}</span>
                        </a>
                    </li>
                @endif
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('wallet.index') }}"
                            ...
                            <svg id="Group_8103" data-name="Group 8103" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <defs>
                                    <clipPath id="clip-path">
                                        <rect id="Rectangle_1386" data-name="Rectangle 1386" width="16" height="16"
                                            fill="#b5b5bf" />
                                    </clipPath>
                                </defs>
                                        ...
                                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="19.998" height="19.998"
                                                ...
                                                <g id="Group_25000" data-name="Group 25000" transform="translate(-298 -935.05)">
                                                    ...
                                                    <rect id="Rectangle_18625" data-name="Rectangle 18625" width="0.992" height="7.939"
                                                        rx="0.496" transform="translate(309.93 942.417) rotate(45)" fill="#b5b5bf" />
                                                </g>
                                            </svg>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('support_ticket.index') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3"
                            style="color: black;">{{ translate('Support Ticket') }}</span>
                        @if ($support_ticket > 0)
