                ...
                <div class="col-lg-6 col">
                    <ul class="list-inline mb-0 d-flex align-items-center mt-2">
                        ...
                        <li class="list-inline-item mr-3 ">
                            <a href="mailto:support@banglashoppers.com"
                                class="text-white fs-12 d-flex align-items-center" style="font-weight: 600;">
        ...
        <div class="position-relative logo-bar-area border-md-nonea z-1025">
            <div class="container">
                <div class="d-flex align-items-center">
                    ...
                    <!-- Header Logo -->
                    <div class="col-auto pl-0 pr-3 d-flex flex-column align-items-start">
                        <!-- Logo -->
                    ...
                    <!-- Search field -->
                    <div class="flex-grow-1 front-header-search d-flex align-items-center mx-xl-5 active ser"style="">
                        <div class="position-relative flex-grow-1 px-3 px-lg-0">
                            <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                                <div class="d-flex position-relative align-items-center">
                                    <div class="d-lg-none d-none" data-toggle="class-toggle"
                    ...
                    <a href="/cart">
                        <div class="d-none d-lg-block mr-10" style="margin-left: 36px;margin-right: 30px;">
                            <svg xmlns="http://www.w3.org/2var(--primary)/svg" width="24" height="20.562"
                                viewBox="0 0 24 20.562"style="margin-right: -21px;">
                                <g id="_5e67fc94b53aaec8ca181b806dd815ee" data-name="5e67fc94b53aaec8ca181b806dd815ee"
                                    ...
                                    <path id="Path_32660" data-name="Path 32660"
                                        ...
                                        transform="translate(-247.711 -429.41)" fill="#91919b" />
                                    <circle id="Ellipse_553" data-name="Ellipse 553" cx="1.724" cy="1.724"
                                        r="1.724" transform="translate(49.612 117.606)" fill="#91919b" />
                                    <path id="Path_32661" data-name="Path 32661"
                                        ...
                                        transform="translate(-609.293 -619.872)" fill="#91919b" />
                                    <circle id="Ellipse_554" data-name="Ellipse 554" cx="1.724" cy="1.724"
                                        r="1.724" transform="translate(40.884 117.606)" fill="#91919b" />
                                    <path id="Path_32662" data-name="Path 32662"
                                        ...
                                        transform="translate(-230.437 -153.024)" fill="#91919b" />
                                    <path id="Path_32663" data-name="Path 32663"
                                        ...
                                        transform="translate(-210.769 -133.152)" fill="#91919b" />
                                </g>
                            </svg>
                        </div>
                    </a>
            ...
            <div class="container h-100">
                <div class="d-flex h-100">
                    ...
                    <div class="d-none d-xl-block align-self-stretch ml-5 mr-0 has-transition bg-black-10"
                        data-hover="dropdown"
                        style="position: fixed; right: 0; top: 50%; transform: translateY(-50%); z-index: 999;">
