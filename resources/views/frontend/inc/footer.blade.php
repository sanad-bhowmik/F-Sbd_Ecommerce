    ...
    <div class="position-relative logo-bar-area border-bottom border-md-nonea z-1025">
        <div class="container">
            <div class="d-flex align-items-center" id="mobile-style">
                ...
                <!-- Header Logo -->
                <div class="col-auto pl-0 pr-3 d-flex align-items-center flex-column position-relative">
                    <!-- Logo Section -->
                    ...
                    <!--<div class="flex-grow-1 d-flex align-items-center bg-white mx-xl-5" style="position: sticky; top: 0; z-index: 9999;">-->
