...
@if (get_setting('footer_title') != null || get_setting('footer_description') != null)
    <section class="bg-light border-top border-bottom mt-auto" style="display:none;">
            ...
            <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="/" class="fs-13 text-soft-light animate-underline-white">Home</a>
                        </li>
                        <li class="mb-2">
                            <a href="/about" class="fs-13 text-soft-light animate-underline-white">About</a>
                        </li>
                        <li class="mb-2">
                            <a href="/contact" class="fs-13 text-soft-light animate-underline-white">Contact</a>
                        </li>
                        <li class="mb-2">
                            <a href="/blog" class="fs-13 text-soft-light animate-underline-white">Blog</a>
                        </li>
                        <li class="mb-2">
                            <a href="/faq" class="fs-13 text-soft-light animate-underline-white">FAQ</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            ...
                            <p class="fs-13 text-soft-light">{{ get_setting('contact_address', null, App::getLocale()) }}
                            </p>
                        </li>
                        <li class="mb-2">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="text-center text-lg-right">
                        ...
                        <div class="mb-3">
                            @php
                                // Query the database to fetch the phone number
                                $phone_number = DB::table('business_settings')
                                    ->where('type', 'contact_phone')
                                    ->value('value'); // Retrieves the value of the 'contact_phone'

                                // If no phone number found, fallback to a default number
                                if (!$phone_number) {
                                    $phone_number = '+8801897608888'; // Default phone number
                                }
                            @endphp

                            <a href="tel:{{ $phone_number }}"
                                class="text-decoration-none d-inline-flex align-items-center"
                                style="font-size: 18px; font-weight: 600; color: #919199; width: 235%; border-bottom: 1px solid white; padding: 10px;">
                                <i class="fas fa-phone-alt mr-2" style="font-size: 20px; color: #919199;"></i>
                                {{ $phone_number }}
                            </a>
                        </div>

                        <!-- Payment Methods -->
                        <ul class="list-inline mb-0 d-flex flex-wrap justify-content-center justify-content-lg-start"
                            style="width: 256%;">
                            @if (get_setting('payment_method_images') != null)
                                @foreach (explode(',', get_setting('payment_method_images')) as $key => $value)
                                    <li class="list-inline-item mx-2 my-2"
                                        style="flex: 0 0 22%; max-width: 22%; text-align: center;">
                                        <img src="{{ uploaded_asset($value) }}" height="32" class="mw-100 h-auto"
                                            style="max-height: 25px;" alt="{{ translate('payment_method') }}">
                                    </li>
                                @endforeach
                            @endif
                        </ul>
...
<!-- FOOTER -->
<footer class="pt-3 pb-7 pb-xl-3 bg-black text-soft-light" style="display:none;">
    <div class="container">
