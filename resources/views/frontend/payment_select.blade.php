                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($carts as $key => $cartItem)
                                                                                    ...
                                                                                    <tr class="cart_item">
                                                                                        <td
                                                                                            class="product-name pl-0 fs-14 text-dark fw-400 border-top-0 border-bottom">
                            ...
                            <div class="card-body text-center px-4 pt-0">
                                <div class="row gutters-10">
                                    ...
                                    @if (get_setting('iyzico') == 1)
                                        ...
                                        <!--            name="payment_option" checked>-->
                                        <!--        <span class="d-block aiz-megabox-elem rounded-0 p-3">-->
                                        <!--            <img src="{{ static_asset('assets/img/cards/roket.png') }}"-->
                                        <!--                class="img-fit mb-2">-->
                                        <!--            <span class="d-block text-center">-->
                                        <!--                <span-->
                                        <!--                    class="d-block fw-600 fs-15">{{ translate('Rocket') }}</span>-->
                                        <!--            </span>-->
                                        <!--        </span>-->
                                        <!--    </label>-->
                                        <!--</div>-->
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="nagad" class="online_payment" type="radio" name="payment_option"
                                                    checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img src="{{ static_asset('assets/img/cards/ssl.png') }}"
                                                        class="img-fit mb-2" style="height: 11vh;">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Sslcommerz') }}</span>
                                                    </span>
                                                </span>
                                    ...
                                    @if (get_setting('bkash') == 1)
                                        <div class="col-6 col-xl-3 col-md-4 d-none">
                                            <label class="aiz-megabox d-block mb-3">
                                    ...
                                    @if (addon_is_activated('paytm'))
                                        ...
                                        @if (get_setting('khalti_payment') == 1)
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="Khalti" class="online_payment" type="radio" name="payment_option"
                                                        checked>
