...
<!--<a href="javascript:void(0)" class="d-flex align-items-center text-dark px-3 h-100" data-toggle="dropdown" data-display="static" title="{{translate('Cart')}}" style="display: flex; align-items: center; text-decoration: none; position: relative;">-->
...
<!-- Total Item Count -->
<!--        <div>-->
<!--            <span style="position: absolute; top: -5px; right: -25px; background: var(--primary); color: white; font-size: 10px; font-weight: bold; padding: 2px 6px; border-radius: 50%;">-->
...
<a href="javascript:void(0)" class="d-flex align-items-center text-dark px-3 h-100"
    ...
    <span style="display: flex; align-items: center; position: relative;">
        <svg fill="#91919b" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="24" viewBox="0 0 902.86 902.86"
            xml:space="preserve" stroke="#91919b">
        ...
        <span
            style="position: absolute;top: -10px;right: -40px;background: var(--primary);color: white;font-size: 10px;font-weight: bold;padding: 3px 11px;border-radius: 50%;display: flex;justify-content: center;align-items: center;">
            {{ count($carts) > 0 ? count($carts) : 0 }}
        </span>
    </span>
    <span style="margin-left: 2px;color: #000;font-weight: bold;margin-top: 18px;">My Cart</span>
</a>
