...
@section('panel_content')
                                ...
                                <div class="ml-3 d-flex flex-column justify-content-between">
                                    ...
                                    @if ($latestOrder)
                                        <div class="d-flex align-items-center">
                                            <span
                                                class="fs-14 fw-400 text-white mb-1 mr-2">{{ translate('Order Code:') }}</span>
                                            <span class="fs-16 fw-700 text-white">{{ $latestOrder->code }} </span> <span
                                                style="margin-left: 4px; color:                                     white;">(Use
                                                this to Track Order)</span>

                                        </div>
                                    @else
                                        <span
                                            class="fs-14 fw-400 text-white mb-1">{{ translate('No Orders Found') }}</span>
                                    @endif
                                </div>
    ...
    <div class="row gutters-16 mt-2"style="width: 310%;display:block;">

        <!-- count summary -->
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="px-4 bg-white border h-100" style="gap: 53px;display: flex;">
                <!-- Cart summary -->
                <a href="{{ route('cart') }}"
                    class="d-flex align-items-center py-4 border-bottom text-decoration-none text-dark">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                ...
                <a href="https://celcombazar.com/save-later"
                    class="d-flex align-items-center py-4 border-bottom text-decoration-none text-dark">
                    <div
                        style="background-color: red; padding: 12px; border-radius: 46px; padding-left: 15px; padding-right: 15px; padding-top: 15px; padding-bottom: 12px;">
                    ...
                    <div class="ml-3 d-flex flex-column justify-content-between">
                        ...
                        // Fetch the count of saved products for the logged-in user
                        $saveLaterCount = DB::table('save_later_product')
                            ->where('user_id', auth()->id())
                            ->count();
                        ?>
                        <span class="fs-20 fw-700 mb-1">{{ sprintf('%02d', $saveLaterCount) }}</span>
                        <span class="fs-14 fw-400 text-secondary">{{ translate('Save For Later') }}</span>
                    </div>
                </a>
            ...
            <div class="px-4 bg-white border h-100" style="gap: 53px;display: flex;">
                ...
                <a href="https://celcombazar.com/purchase_history"
                    class="d-flex align-items-center py-4 text-decoration-none text-dark">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                ...
                <!--    <div style="background-color: red; padding: 12px; border-radius: 46px; padding-left: 15px; padding-right: 15px; padding-top: 15px; padding-bottom: 12px;">-->
                <!--        <svg fill="#fff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16" viewBox="-15.44 -15.44 76.28 76.28" xml:space="preserve" stroke="#b5b5bf" stroke-width="0.00045402">-->
                <!--            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>-->
                <!--            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>-->
                <!--            <g id="SVGRepo_iconCarrier">-->
                <!--                <g>-->
                ...
                <!--    </div>-->
                <!--    <div class="ml-3 d-flex flex-column justify-content-between">-->
                <!--        <span class="fs-20 fw-700 mb-1" id="compare-count">{{ sprintf('%02d', $saveLaterCount) }}</span>-->
                <!--        <span class="fs-14 fw-400 text-secondary">{{ translate('Compare') }}</span>-->
                <!--    </div>-->
                <!--</div>-->

                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        // Function to fetch and update the compare count
                        function updateCompareCount() {
                            fetch('/compare/count')
                                .then(response => response.json())
                                .then(data => {
                                    const compareCountElement = document.getElementById('compare-count');
                                    compareCountElement.textContent = data.count < 10 ? `0${data.count}` : data.count;
                                })
                                .catch(error => console.error('Error fetching compare count:', error));
                        }

                        // Initial count update
                        updateCompareCount();

                        // Update every second (1000 milliseconds) to keep the count updated
                        setInterval(updateCompareCount, 1000);
                    });
                </script>
        ...
        <div class="col-xl-4 col-md-6 mb-4"style="display: none;">
            <div class="px-4 bg-white border h-100" style="display: flex;">
                Cart summary
                <div class="d-flex align-items-center py-4 border-bottom">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                        <g id="Group_25000" data-name="Group 25000" transform="translate(-1367 -427)">
