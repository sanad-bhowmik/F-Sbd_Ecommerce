    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                ...
                @else
                    <img class="mw-100" src="{{ static_asset('assets/img/logo.jpeg') }}" class="brand-icon"
                        alt="{{ get_setting('site_name') }}">
                @endif
            </a>
        </div>
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @can('admin_dashboard')
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('userNotify') }}" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg fill="#584769" height="16" width="16" version="1.1" id="Capa_1"
                            ...
                            <span class="aiz-side-nav-text">{{ translate('User Notify') }}</span>
                        </a>
                    </li>
                @endcan
                ...
                @canany(['header_setup', 'footer_setup', 'view_all_website_pages', 'website_appearance', 'authentication_layout_settings'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('edit_website_page')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('home_comparisons.index') }}"
                                        class="aiz-side-nav-link {{ request()->routeIs('home_comparisons.index') ? 'active' : '' }}">
                                        <span class="aiz-side-nav-text">{{ translate('Comparison Products') }}</span>
                                    </a>
                                </li>
                            @endcan
